#!/usr/bin/env python3
# =========================================================
# FULL RUNNABLE SCRIPT (AUB): Compare pseudo-absence methods
...
#
# Evaluation (kept consistent with your old pipeline):
#   - CellID aggregation
...
#
# USER REQUEST:
#   Keep everything the same, ONLY change the LLM prompt to an eco-narrative style,
#   applied only to candidates coming from CONTROLLED shortlist (as already done).
# =========================================================
...
OUT_DIR = "/Users/kristianmiok/Desktop/Lucian/LLM/Data/After Review/New/AUB Results/out_step3_compare_random_controlled_llm3"
...
# Eco narrative (edit freely)
ECOLOGY_TEXT = (
    "Austropotamobius bihariensis (AUB) is a native crayfish of the white-clawed crayfish complex. "
    "It is typically linked to cooler, well-oxygenated upland streams with higher water quality. "
    "It is sensitive to pollution and habitat degradation; presence is less likely in warm, low-quality, "
    "or otherwise degraded reaches."
)
...
# =========================================================
# THIS IS THE ONLY PLACE WE CHANGED LOGIC: the LLM prompt text.
...
def llm3_rank_shortlist(
    ...
    # Optional columns (if present) to enrich eco narrative
...
# FID-level overlaps + sizes (like old evaluation)
